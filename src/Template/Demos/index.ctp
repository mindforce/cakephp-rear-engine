<?php
$this->Html->css([
		'RearEngine.plugins/morris/morris-0.4.3',
		'RearEngine.plugins/timeline/timeline',
	],
	['block' => true]
);
$this->Html->script([
		'RearEngine.plugins/morris/raphael-2.1.0',
		'RearEngine.plugins/morris/morris',
		'RearEngine.demo/dashboard-demo'
	],
	['block' => true]
);
