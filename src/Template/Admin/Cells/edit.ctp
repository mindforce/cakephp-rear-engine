...
<?php $this->assign('title', __('Edit Cell')); ?>
...
<div class="btn-group">
	...
	<?= $this->Html->link(__('Delete'), ['action' => 'delete', $cell->id], ['title' => __('Are you sure you want to delete # {0}?', $cell->id), 'class' => 'btn btn-danger btn-confirmation', 'icon' => 'fa-trash-o']); ?> 
</div>
<?php $this->end(); ?>