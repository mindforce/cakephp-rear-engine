...
<?php
	...
	if (Plugin::loaded('DebugKit')):
		echo '<div class="alert alert-success">DebugKit plugin is present</div>';
	else:
		echo '<div class="alert alert-warning">';
			echo 'DebugKit is not installed. It will help you inspect and debug different aspects of your application.';
			echo '<br/>';
			echo 'You can install it from <a class="alert-link" href="https://github.com/cakephp/debug_kit">github</a>';
		echo '</div>';
	endif;
?>
